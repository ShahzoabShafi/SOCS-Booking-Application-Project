            ...
            <div id="requestList">
                ...
                <div className="card" key={index}>
                    <div className="header-line">
                        <h3>{req.title}</h3>
                        <button onClick={() => handleUpdate(req.id, "declined")}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        ...
                        <button onClick={() => handleUpdate(req.id, "accepted")}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    ...
                    <div className="line">
                        ...
                        <p>Time: {req.start_time.time()} - {req.end_time.time()} </p>
                    </div>
